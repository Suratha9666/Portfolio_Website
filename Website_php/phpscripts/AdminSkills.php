...
<body id="skills">
	...
	<form name="form1" action="AddWork.php" method="post">
		<button id="buttonx" name="formVar" style="float:right;margin-right:250px;font-size: 17px;padding: 4px;">ADD WORK EXPERIENCE</button> <br><br><br>
	</form>
    <section id="workexp">
	    <table>
	        <tr>
	           ...
	           <td>
	               <div class="workright1" style='margin-left:100px;margin-top:-110px;'>
    			        ...
    			        <form name="form2" action="EditWork.php?id=<?php echo $id; ?>" method="post">
    			        	<button name="edit" style="margin-left:60px;font-size: 17px;padding: 4px;">EDIT</button>
    			        </form>
    			        <br>
    			        <form name="form3" action="DeleteWork.php?id=<?php echo $id; ?>" method="post">
							<button onclick="alert('Are you sure you want to delete this record?')" style="margin-left:60px;font-size: 17px;padding: 4px;">DELETE</button><br><br><br><br>
						</form>
    			        <?php }"</p>" ?>
		            </div>
	           </td>
	...
	<form name="form4" action="AddEducation.php" method="post">
		<button name="addedu" style="float:right;margin-right:250px;font-size: 17px;padding: 4px;">ADD EDUCATION</button> <br><br>
	</form>
	           ...
	           <td>
	               <div class="eduright1" style='margin-left:800px;margin-top:-70px;width:400px;'>
    			        ...
    			        <form name="form6" action="DeleteEducation.php?id=<?php echo $degree; ?>" method="post">
							<button onclick="alert('Are you sure you want to delete this record?')" style="margin-left:60px;font-size: 17px;padding: 4px;">DELETE</button><br><br><br><br><br><br>
						</form>
    			        <?php }"</p>" ?>
		            </div>
	           </td>
