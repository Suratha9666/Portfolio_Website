...
<body id="hire">
	...
	<form name="form7" action="AddHire.php" method="post">
		<button onclick=""style="float:right;margin-right:400px;font-size: 17px;padding: 4px;">ADD HIRE</button>
				...
				<td>
					<div style="margin-left:-600px;margin-top:-100px;">
						...
						<form name="form8" action="EditHire.php?id=<?php echo $id; ?>" method="post">
							<button onclick="" style="margin-left:10px;font-size: 17px;padding: 4px;">EDIT</button>
						</form>
						<form name="form9" action="DeleteHire.php?id=<?php echo $id; ?>" method="post">
							<button onclick="alert('Are you sure you want to delete this record?')" style="margin-left:10px;font-size: 17px;padding: 4px;">DELETE</button>
						</form><br>
						<a class="desc" href="AdminCustomers.php" style="color:white;margin-top:-2px;"><strong class="str1">CONTACT US</strong></p>
						<?php } ?>
					</div>
				</td>
			</tr>
