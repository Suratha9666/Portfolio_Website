...
<body id="works">
	...
	<form name="form10" action="AddImage.php" method="post">
		<button onclick=""style="margin-left:100px;font-size: 17px;padding: 4px;display: none;">ADD LATEST WORK</button><br><br><br>
	</form>
	<div class="portfolioContainer">
        ...
        <div class="img1">
            ...
            <form class="forms" name="form11" style="margin-top:-140px;margin-left:280px;" action="EditImage.php?id=<?php echo substr($img,0,1); ?>" method="post">
   		        <br><br><button onclick="" style="font-size: 14px;padding: 4px;display: none;">EDIT</button><br><br>
   	        </form>
   	        <form class="forms" name="form12" style="margin-top:-50px;margin-left:-50px;" action="DeleteImage.php?id=<?php echo substr($img,0,1); ?>" method="post">
		        <button onclick="alert('Are you sure you want to delete this record?')" style="font-size: 14px;padding: 4px;display: none;">DELETE</button>
	         </form>
          </div>
          <?php }?>
	</div>
